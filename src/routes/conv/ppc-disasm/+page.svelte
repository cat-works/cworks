<script lang="ts">
  import InlineConverter from "$component/InlineConverter.svelte";
...
<svelte:head>
  <script src="/capstone-ppc.js"></script>
</svelte:head>
...
<InlineConverter
  ...
  bind:selection_end
>
  <svelte:fragment slot="configurations"></svelte:fragment>
